...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <div class="single-product">
      <div class="mb-3">
        <img class="product-image w-75" src=${product.image}></img>
      </div>
      ...
      <h5 style="color: orange;">Total Rated: ${product.rating.count}</h5>
      <h5 style="color: orange;">Average Rating: ${product.rating.rate}</h5>
      </div>
      </div>
      `;
